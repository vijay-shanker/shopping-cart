    ...
    $.fn.formset = function(opts)
    {
        var options = $.extend({}, $.fn.formset.defaults, opts),
            ...
            insertDeleteLink = function(row) {
                ...
                row.find('a.' + options.deleteCssClass).click(function() {
                    var rowClass = $(this).parents('.' + options.formCssClass).attr('class'),
                    ...
                    if (del.length) {
                        ...
                        var forms = $('[class="' + rowClass + '"]').not('.formset-custom-template');
        ...
        $$.each(function(i) {
            ...
            if (del.length) {
                ...
                if (del.attr('id') && ($('[for="' + del.attr('id') + '"]').length)) {
                	$('[for="' + del.attr('id') + '"]').hide();
                }
                del.parent('.ctrlHolder').hide();
                del.remove();
            }
        ...
        if ($$.length) {
            ...
            if ($$.attr('tagName') == 'TR') {
                ...
                $$.filter(':last').after('<p class="add-another"><a class="' + options.addCssClass + '" href="javascript:void(0)">' + options.addText + '</a></p>');
